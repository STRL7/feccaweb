...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220105_feccawp_1b61926236d1dbdd6707_20220105151604_archive.zip';
	const ARCHIVE_SIZE		 = '22292716';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1b61926-05151604';
    const SECONDARY_PACKAGE_HASH = '124acd1-05151604';
	const VERSION			 = '1.4.3';
