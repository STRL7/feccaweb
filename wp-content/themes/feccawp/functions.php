...
function feccawp_scripts() {
	wp_enqueue_script( 'jquerys', 'https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js');
...
function enqueue_scripts() {
	...
	wp_enqueue_script( 'castomizer', get_template_directory_uri() . '/js/customizer.js', array('jquery', 'swiper'), '', true);
    wp_enqueue_script( 'script', get_template_directory_uri() . '/js/script.js', array('jquery', 'swiper'), '', true);
  //Bootstrap
